/****************************************************************************
** Meta object code from reading C++ file 'game_player.h'
**
...
#error "The header file 'game_player.h' doesn't include <QObject>."
...
const QMetaObject gamePlayer::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_gamePlayer.data,
      qt_meta_data_gamePlayer,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *gamePlayer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_gamePlayer.stringdata0))
        return static_cast<void*>(const_cast< gamePlayer*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< gamePlayer*>(this));
