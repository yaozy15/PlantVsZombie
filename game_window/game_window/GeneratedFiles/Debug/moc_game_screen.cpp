...
QT_MOC_LITERAL(1, 11, 12), // "zombieAttack"
QT_MOC_LITERAL(2, 24, 0) // ""

    },
    "gameScreen\0zombieAttack\0"
};
...
void gameScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&gameScreen::zombieAttack)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject gameScreen::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_gameScreen.data,
...
void *gameScreen::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< gameScreen*>(this));
